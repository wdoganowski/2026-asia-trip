...
```mermaid
flowchart TD
    AP1(["✈ Fly in: Siem Reap SAI · 22 Nov 18:45"]) --> A["Siem Reap · Angkor<br/>Days 1–3"]
    A -->|🛥 private boat · Tonlé Sap + Sangker river| B["Battambang<br/>Days 4–5"]
    B -->|road ~5–6 h via Udong| C["Phnom Penh<br/>Days 6–7"]
    C -->|road via Phnom Chisor + Phnom Da| D["Kampot · Bokor<br/>Days 8–10"]
    D -->|road ~40 min · day trip| E["Kep"]
    E -->|🛥 speedboat from Kampot| F["Koh Rong Sanloem<br/>Days 11–16"]
    F -.->|🟡 to decide| G["Siem Reap · last two nights<br/>Days 15–16, 6–7 Dec"]
    G --> AP2(["✈ Fly out: Siem Reap SAI · 8 Dec 09:55"])
```
