...
```mermaid
flowchart TD
    AP1(["✈ Fly in: Hanoi HAN"]) --> A["Hanoi · Days 1-2"]
    A -->|road| B["Ninh Binh · Day 3"]
    B -->|road/boat| C["Lan Ha Bay · Days 4-5"]
    C -->|road back to Hanoi| D["Hanoi (overnight)"]
    D -->|✈ internal flight| E["Phnom Penh · Days 6-7"]
    E -->|road + ferry| F["Koh Rong Sanloem · Days 8-10"]
    F -->|ferry + road| G["Kampot / Bokor · Days 11-12"]
    G -->|road| H["Kep · Day 13"]
    H -->|Ha Tien land border| I["Mekong Delta · Days 13-15"]
    I -->|road| J["Saigon · Days 16-17"]
    J --> AP2(["✈ Fly out: Saigon SGN"])
```
